...
const otpForEmailChange = async (email, name) => {
  try {
    ...
    const subject = "OTP for email change";
    const htmlMsg = `
    <p>Dear ${name},</p>
    <p>You are receiving this email to verify your email address change request. Please use the following OTP to complete the process:</p>
    <h2>${otp}</h2>
    <p>This code is valid for 10 minutes. Please enter it on the email updation page to verify your email address.</p>
