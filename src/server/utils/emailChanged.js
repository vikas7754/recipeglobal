...
const emailChanged = async (email, name, newEmail) => {
  try {
    ...
    const subject = "Email Changed Successfully";
    const htmlMsg = `
    <p>Dear ${name},</p>
    <p>Your email address has been successfully changed to ${newEmail}. You can now use your new email address for all future communications with us.</p>
